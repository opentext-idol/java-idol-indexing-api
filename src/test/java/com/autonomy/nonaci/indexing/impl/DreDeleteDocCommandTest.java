...
public class DreDeleteDocCommandTest {
    private static final Map<String, String> nullDocs = new HashMap<>() {{
        put("Docs", null);
    }};
    private final DreDeleteDocCommand command = new DreDeleteDocCommand();
    ...
    public void testBasicSetters() {
        command.setStateId("abc123");
        assertThat(command.getParameters(), equalTo(Map.of("StateID", "abc123")));
        assertThat(command.getQueryString(), equalTo("StateID=abc123"));
    }
